          ...
          <div className="auth-form-wrapper">
            ...
            <form className="auth-form" onSubmit={handleFormSubmit}>
              ...
              {!isLogin && (
                <div className="form-row">
                  <div className="form-group half">
                    <label htmlFor="preferred_language">{t('label_learning_language', 'Learning Language')}</label>
                    <select id="preferred_language" name="preferred_language" value={formData.preferred_language} onChange={handleInputChange}>
                  ...
                  <div className="form-group half">
                    <label htmlFor="proficiency_level">{t('label_proficiency', 'Proficiency')}</label>
                    <select id="proficiency_level" name="proficiency_level" value={formData.proficiency_level} onChange={handleInputChange}>
              ...
              {!isLogin && (
                <div className="form-row">
                  <div className="form-group half">
                    <label htmlFor="education_level">{t('label_education', 'Education Level')}</label>
                    <select id="education_level" name="education_level" value={formData.education_level} onChange={handleInputChange}>
              ...
              <Button type="submit" variant="primary" size="lg" className="auth-submit-btn" style={{ width: '100%', marginTop: '1rem' }}>
